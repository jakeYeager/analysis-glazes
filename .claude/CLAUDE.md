...
- **`Black Copper Oxide`** (used in Ballingham Black Luster) is still `not_found` — IMCO has no listing under that exact name. The likely match is their plain "Copper Oxide" (SKU 25296, industry convention treats unqualified "copper oxide" as the black/CuO form), but Jake chose to leave it flagged rather than assume (2026-07-04). Confirm with the supplier before pricing it. Ballingham Black Luster's total is understated until then.
